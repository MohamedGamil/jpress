...
class Ajax {
	...
	public function __construct(  ) {
		//Ajax oembed
		add_action( 'wp_ajax_jpress_get_oembed', array( $this, 'get_oembed_ajax' ) );
		add_action( 'wp_ajax_nopriv_jpress_get_oembed', array( $this, 'get_oembed_ajax' ) );

		add_action( 'wp_ajax_jpress_get_items', array( $this, 'get_items_ajax' ) );
		add_action( 'wp_ajax_nopriv_jpress_get_items', array( $this, 'get_items_ajax' ) );
	...
	*/
	public function get_oembed_ajax(){
		...
		if( ! wp_verify_nonce( $_POST['ajax_nonce'], 'jpress_ajax_nonce' ) ){
			die();
		}
