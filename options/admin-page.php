...
add_action( 'xbox_init', 'appBear_options');
function appBear_options(){
	$settings_arg = array(
		...
		'layout' => 'wide',//wide
		'header' => array(
			'icon' => '<img src="'.XBOX_URL.'img/a-logo.svg"/>',
	...
	$settings = xbox_new_admin_page( $settings_arg );

	$settings->add_main_tab( array(
		'name' => 'Main tab',
		'id' => 'main-tab',
		'items' => array(
			'general' => '<i class="xbox-icon fa fa-cog"></i>'.__( 'General', 'textdomain' ),
			'user_guide' => '<i class="xbox-icon xbox-icon-photo"></i>'.__( 'User Guide', 'textdomain' ),
			'topbar' => '<i class="xbox-icon fa fa-sliders"></i>'.__( 'Topbar', 'textdomain' ),
			'sidemenu' => '<i class="xbox-icon fa fa-bars"></i>'.__( 'Side Menu', 'textdomain' ),
			'homepage' => '<i class="xbox-icon xbox-icon-home"></i>'.__( 'Home Tab', 'textdomain' ),
			'bottombar' => '<i class="xbox-icon fa fa-th-large"></i>'.__( 'Bottom Bar', 'textdomain' ),
			'archives' => '<i class="xbox-icon fa-tags"></i>'.__( 'Archives', 'textdomain' ),
			'styling' => '<i class="xbox-icon fa fa-paint-brush"></i>'.__( 'Styling', 'textdomain' ),
			// 'typography' => '<i class="xbox-icon xbox-icon-font"></i>'.__( 'Typography', 'textdomain' ),
			'advertisement' => '<i class="xbox-icon xbox-icon-photo"></i>'.__( 'Advertisement', 'textdomain' ),
			'settings' => '<i class="xbox-icon xbox-icon-cogs"></i>'.__( 'Settings Tab', 'textdomain' ),
			'import' => '<i class="xbox-icon xbox-icon-database"></i>'.__( 'Import/Export', 'textdomain' ),
		),
		'options' => array(
			'conditions' => array(
				'sidemenu' => array(
	...
	$settings->open_tab_item('topbar');
		$settings->add_field(array(
			...
			'id' => 'logo-light',
			'type' => 'file',
			'default' => XBOX_URL .'img/jannah-logo-light.png',
		));
		$settings->add_field(array(
			'name' => __('Logo (Dark)', 'textdomain' ),
			'id' => 'logo-dark',
			'type' => 'file',
			'default' => XBOX_URL .'img/jannah-logo-dark.png',
			'options' => array(
				'show_if' => array('switch_theme_mode', '=', 'true'),
			),
		));
	...
	$tabs->close_mixed_field();
		...
		$tabs->add_field(array(
			...
			'id' => 'page',
			'type' => 'select',
			'items' => XboxItems::posts_by_post_type( 'page' ),
			'options' => array(
	...
	$settings->open_tab_item('homepage');
		...
		$tabs->add_field( array(
			...
			'items' => array(
				'TabsLayout.tab1' => XBOX_URL.'options/img/topbar_tabs/tab_1.png',
				'TabsLayout.tab2' => XBOX_URL.'options/img/topbar_tabs/tab_2.png',
				'TabsLayout.tab3' => XBOX_URL.'options/img/topbar_tabs/tab_3.png',
				'TabsLayout.tab4' => XBOX_URL.'options/img/topbar_tabs/tab_4.png',
				'TabsLayout.tab5' => XBOX_URL.'options/img/topbar_tabs/tab_5.png',
				'TabsLayout.tab6' => XBOX_URL.'options/img/topbar_tabs/tab_6.png'
			),
			'options' => array(
				'width' => '200px',
		...
		$tabs->add_field( array(
			...
			'items' => array(
				'PostLayout.cardPost' => XBOX_URL.'options/img/blocks/cardPost.png',
				'PostLayout.endThumbPost' => XBOX_URL.'options/img/blocks/endThumbPost.png',
				'PostLayout.featuredMetaPost' => XBOX_URL.'options/img/blocks/featuredMetaPost.png',
				'PostLayout.featuredPost' => XBOX_URL.'options/img/blocks/featuredPost.png',
				'PostLayout.gridPost' => XBOX_URL.'options/img/blocks/gridPost.png',
				'PostLayout.imagePost' => XBOX_URL.'options/img/blocks/imagePost.png',
				'PostLayout.minimalPost' => XBOX_URL.'options/img/blocks/minimalPost.png',
				'PostLayout.relatedPost' => XBOX_URL.'options/img/blocks/relatedPost.png',
				'PostLayout.simplePost' => XBOX_URL.'options/img/blocks/simplePost.png',
				'PostLayout.startThumbPost' => XBOX_URL.'options/img/blocks/startThumbPost.png',
				'PostLayout.startThumbPostCompact' => XBOX_URL.'options/img/blocks/startThumbPostCompact.png',
			),
			'options' => array(
				'width' => '155px',
				'show_if' => array('tabsbar_categories_tab', '=', 'true')
	...
	$settings->open_tab_item('archives');
		...
		$archives_categories->add_field( array(
			...
			'items' => array(
				'CategoriesLayout.cat1' => XBOX_URL.'options/img/categories/cat_1.png',
				'CategoriesLayout.cat2' => XBOX_URL.'options/img/categories/cat_2.png',
				'CategoriesLayout.cat3' => XBOX_URL.'options/img/categories/cat_3.png',
				'CategoriesLayout.cat4' => XBOX_URL.'options/img/categories/cat_4.png',
				'CategoriesLayout.cat5' => XBOX_URL.'options/img/categories/cat_5.png',
			),
			'options' => array(
				'width' => '155px',
			),
		...
		// $archives_category->add_field(array(
		// 	'name' => __( 'Catgeory', 'textdomain' ),
		// 	'id' => 'archives-category-options-category',
		// 	'type' => 'switcher',
		// 	'default'	=>	'true',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_category->add_field(array(
		// 	'name' => __( 'Author', 'textdomain' ),
		// 	'id' => 'archives-category-options-author',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_category->add_field(array(
		// 	'name' => __( 'Tags', 'textdomain' ),
		// 	'id' => 'archives-category-options-tags',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_search->add_field(array(
		// 	'name' => __( 'Author', 'textdomain' ),
		// 	'id' => 'archives-search-options-author',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_search->add_field(array(
		// 	'name' => __( 'Tags', 'textdomain' ),
		// 	'id' => 'archives-search-options-tags',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_favorites->add_field(array(
		// 	'name' => __( 'Author', 'textdomain' ),
		// 	'id' => 'archives-favorites-options-author',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
		...
		// $archives_favorites->add_field(array(
		// 	'name' => __( 'Tags', 'textdomain' ),
		// 	'id' => 'archives-favorites-options-tags',
		// 	'type' => 'switcher',
		// 	'default'	=>	'false',
		// 	'options' => array(
		// 		'on_value'  => 'true',
	...
	$settings->open_tab_item('advertisement');
		...
		// $admob->add_field(
		// 	array(
		// 		'name'    => __( 'Before Submit New Comment', 'textdomain' ),
		// 		'id'      => 'advertisement_interstatial_before_comment_toggle',
		// 		'type'  => 'switcher',
		// 		'default'	=>	'false',
		// 		'options' => array(
		// 			'on_value'  => 'true',
		...
		// 	array(
		// 		'name'    => __( 'Before Submit New Comment', 'textdomain' ),
		// 		'id'      => 'advertisement_rewarded_before_comment_toggle',
		// 		'type'  => 'switcher',
		// 		'default'	=>	'false',
		// 		'options' => array(
		// 			'on_value'  => 'true',
	...
	$settings->open_tab_item('typography');
		...
		$fontfamily->add_field( array(
			...
			'items' => array(
				...
				__( 'Web Safe Fonts',   'textdomain' ) => XboxItems::web_safe_fonts(),
				__( 'Google Fonts',   'textdomain' ) => XboxItems::dart_google_fonts()
			),
			'options' => array(
				'search' => true, //Displays an input to search items. Default: false
			)
		));
		$fontfamily->add_field( array(
			...
			'items' => array(
				...
				'Google Fonts' => XboxItems::dart_google_fonts()
			),
			'options' => array(
				'search' => true, //Displays an input to search items. Default: false
			)
			// 'items' => array(
			// 	'-SFProDisplay' => __( 'SF Pro Display',   'textdomain' ),
			// ),
		));
	...
	$settings->open_tab_item('settings');
		...
		$settings->open_mixed_field(array('name' => __('Share info', 'textdomain' ),'options'	=>	array('show_if' => array('local-settingspage-aboutapp', '=', 'true'))));
			$settings->add_field(array(
				'name' => __('Logo (Light)', 'textdomain' ),
	...
	$settings->open_tab_item('import');
		$settings->add_import_field(array(
			...
			'items' => array(
				XBOX_URL.'options/demos/demo1.json' => XBOX_URL.'options/img/demos/demo1.jpg',
				XBOX_URL.'options/demos/demo2.json' => XBOX_URL.'options/img/demos/demo2.jpg',
				XBOX_URL.'options/demos/demo3.json' => XBOX_URL.'options/img/demos/demo3.jpg',
				XBOX_URL.'options/demos/demo4.json' => XBOX_URL.'options/img/demos/demo4.jpg',
				XBOX_URL.'options/demos/demo5.json' => XBOX_URL.'options/img/demos/demo5.jpg',
				XBOX_URL.'options/demos/demo6.json' => XBOX_URL.'options/img/demos/demo6.jpg',
				XBOX_URL.'options/demos/demo7.json' => XBOX_URL.'options/img/demos/demo7.jpg',
				XBOX_URL.'options/demos/demo8.json' => XBOX_URL.'options/img/demos/demo8.jpg'
			),
			'options' => array(
	...
	$translations = xbox_new_admin_page( $translations_arg );
